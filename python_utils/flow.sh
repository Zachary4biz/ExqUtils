...
formal_latest=`pip search zac-pyutils | grep zac-pyutils | grep -Eo 'zac-pyutils \([0-9\.]+\)'`
test_latest=`pip search zac-pyutils -i https://test.pypi.org/pypi | grep zac-pyutils | grep -Eo 'zac-pyutils \([0-9\.]+\)'`
